...
class HandledLoginRequest {
    ...
    constructor(subject) { 
        ...
        HandledLoginRequest.initialize(this, subject);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HandledLoginRequest();
 ...
 * @member {String} acr
 */
HandledLoginRequest.prototype['acr'] = undefined;
 ...
 */
HandledLoginRequest.prototype['context'] = undefined;
 ...
 */
HandledLoginRequest.prototype['force_subject_identifier'] = undefined;

/**
 * Remember, if set to true, tells ORY Hydra to remember this user by telling the user agent (browser) to store a cookie with authentication data. If the same user performs another OAuth 2.0 Authorization Request, he/she will not be asked to log in again.
 * @member {Boolean} remember
 */
HandledLoginRequest.prototype['remember'] = undefined;
 ...
 */
HandledLoginRequest.prototype['remember_for'] = undefined;

/**
 * Subject is the user ID of the end-user that authenticated.
 * @member {String} subject
 */
HandledLoginRequest.prototype['subject'] = undefined;
...
export default HandledLoginRequest;
