...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydra.SwaggerRevokeOAuth2TokenParameters();
  });
  ...
  describe('SwaggerRevokeOAuth2TokenParameters', function() {
    it('should create an instance of SwaggerRevokeOAuth2TokenParameters', function() {
      ...
      //var instane = new OryHydra.SwaggerRevokeOAuth2TokenParameters();
      //expect(instance).to.be.a(OryHydra.SwaggerRevokeOAuth2TokenParameters);
    });
