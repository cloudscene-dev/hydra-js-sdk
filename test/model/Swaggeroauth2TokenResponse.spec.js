...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydra.Swaggeroauth2TokenResponse();
  });
  ...
  describe('Swaggeroauth2TokenResponse', function() {
    it('should create an instance of Swaggeroauth2TokenResponse', function() {
      // uncomment below and update the code to test Swaggeroauth2TokenResponse
      //var instane = new OryHydra.Swaggeroauth2TokenResponse();
      //expect(instance).to.be.a(OryHydra.Swaggeroauth2TokenResponse);
    });
