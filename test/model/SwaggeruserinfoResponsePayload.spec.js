...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydra.SwaggeruserinfoResponsePayload();
  });
  ...
  describe('SwaggeruserinfoResponsePayload', function() {
    it('should create an instance of SwaggeruserinfoResponsePayload', function() {
      ...
      //var instane = new OryHydra.SwaggeruserinfoResponsePayload();
      //expect(instance).to.be.a(OryHydra.SwaggeruserinfoResponsePayload);
    });
