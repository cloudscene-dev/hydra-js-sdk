...
class AcceptLoginRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceptLoginRequest();
 ...
 */
AcceptLoginRequest.prototype['force_subject_identifier'] = undefined;

/**
 * Remember, if set to true, tells ORY Hydra to remember this user by telling the user agent (browser) to store a cookie with authentication data. If the same user performs another OAuth 2.0 Authorization Request, he/she will not be asked to log in again.
 * @member {Boolean} remember
 */
AcceptLoginRequest.prototype['remember'] = undefined;
 ...
 */
AcceptLoginRequest.prototype['remember_for'] = undefined;

/**
 * Subject is the user ID of the end-user that authenticated.
 * @member {String} subject
 */
AcceptLoginRequest.prototype['subject'] = undefined;
...
export default AcceptLoginRequest;
