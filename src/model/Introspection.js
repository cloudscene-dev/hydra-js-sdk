...
class Introspection {
    ...
    constructor(active) { 
        ...
        Introspection.initialize(this, active);
    }
 ...
 */
Introspection.prototype['active'] = undefined;

/**
 * Audience contains a list of the token's intended audiences.
 * @member {Array.<String>} aud
 */
Introspection.prototype['aud'] = undefined;

/**
 * ClientID is aclient identifier for the OAuth 2.0 client that requested this token.
 * @member {String} client_id
 */
Introspection.prototype['client_id'] = undefined;

/**
 * Expires at is an integer timestamp, measured in the number of seconds since January 1 1970 UTC, indicating when this token will expire.
 * @member {Number} exp
 */
Introspection.prototype['exp'] = undefined;

/**
 * Extra is arbitrary data set by the session.
 * @member {Object.<String, Object>} ext
 */
Introspection.prototype['ext'] = undefined;

/**
 * Issued at is an integer timestamp, measured in the number of seconds since January 1 1970 UTC, indicating when this token was originally issued.
 * @member {Number} iat
 */
Introspection.prototype['iat'] = undefined;

/**
 * IssuerURL is a string representing the issuer of this token
 * @member {String} iss
 */
Introspection.prototype['iss'] = undefined;

/**
 * NotBefore is an integer timestamp, measured in the number of seconds since January 1 1970 UTC, indicating when this token is not to be used before.
 * @member {Number} nbf
 */
Introspection.prototype['nbf'] = undefined;
 ...
 */
Introspection.prototype['obfuscated_subject'] = undefined;

/**
 * Scope is a JSON string containing a space-separated list of scopes associated with this token.
 * @member {String} scope
 */
Introspection.prototype['scope'] = undefined;

/**
 * Subject of the token, as defined in JWT [RFC7519]. Usually a machine-readable identifier of the resource owner who authorized this token.
 * @member {String} sub
 */
Introspection.prototype['sub'] = undefined;

/**
 * TokenType is the introspected token's type, for example `access_token` or `refresh_token`.
 * @member {String} token_type
 */
Introspection.prototype['token_type'] = undefined;

/**
 * Username is a human-readable identifier for the resource owner who authorized this token.
 * @member {String} username
 */
Introspection.prototype['username'] = undefined;
