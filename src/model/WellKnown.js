...
class WellKnown {
     ...
     */
    constructor(authorizationEndpoint, idTokenSigningAlgValuesSupported, issuer, jwksUri, responseTypesSupported, subjectTypesSupported, tokenEndpoint) { 
        
        WellKnown.initialize(this, authorizationEndpoint, idTokenSigningAlgValuesSupported, issuer, jwksUri, responseTypesSupported, subjectTypesSupported, tokenEndpoint);
    }
     ...
     */
    static initialize(obj, authorizationEndpoint, idTokenSigningAlgValuesSupported, issuer, jwksUri, responseTypesSupported, subjectTypesSupported, tokenEndpoint) { 
        obj['authorization_endpoint'] = authorizationEndpoint;
        obj['id_token_signing_alg_values_supported'] = idTokenSigningAlgValuesSupported;
        obj['issuer'] = issuer;
        obj['jwks_uri'] = jwksUri;
        obj['response_types_supported'] = responseTypesSupported;
        obj['subject_types_supported'] = subjectTypesSupported;
 ...
 */
WellKnown.prototype['claims_parameter_supported'] = undefined;
 ...
 */
WellKnown.prototype['grant_types_supported'] = undefined;

/**
 * JSON array containing a list of the JWS signing algorithms (alg values) supported by the OP for the ID Token to encode the Claims in a JWT.
 * @member {Array.<String>} id_token_signing_alg_values_supported
 */
WellKnown.prototype['id_token_signing_alg_values_supported'] = undefined;

/**
 * URL using the https scheme with no query or fragment component that the OP asserts as its IssuerURL Identifier. If IssuerURL discovery is supported , this value MUST be identical to the issuer value returned by WebFinger. This also MUST be identical to the iss Claim value in ID Tokens issued from this IssuerURL.
 * @member {String} issuer
 */
WellKnown.prototype['issuer'] = undefined;

/**
 * URL of the OP's JSON Web Key Set [JWK] document. This contains the signing key(s) the RP uses to validate signatures from the OP. The JWK Set MAY also contain the Server's encryption key(s), which are used by RPs to encrypt requests to the Server. When both signing and encryption keys are made available, a use (Key Use) parameter value is REQUIRED for all keys in the referenced JWK Set to indicate each key's intended usage. Although some algorithms allow the same key to be used for both signatures and encryption, doing so is NOT RECOMMENDED, as it is less secure. The JWK x5c parameter MAY be used to provide X.509 representations of keys provided. When used, the bare key values MUST still be present and MUST match those in the certificate.
 * @member {String} jwks_uri
 */
WellKnown.prototype['jwks_uri'] = undefined;

/**
 * URL of the OP's Dynamic Client Registration Endpoint.
 * @member {String} registration_endpoint
 */
WellKnown.prototype['registration_endpoint'] = undefined;

/**
 * Boolean value specifying whether the OP supports use of the request parameter, with true indicating support.
 * @member {Boolean} request_parameter_supported
 */
WellKnown.prototype['request_parameter_supported'] = undefined;

/**
 * Boolean value specifying whether the OP supports use of the request_uri parameter, with true indicating support.
 * @member {Boolean} request_uri_parameter_supported
 */
WellKnown.prototype['request_uri_parameter_supported'] = undefined;
 ...
 */
WellKnown.prototype['require_request_uri_registration'] = undefined;

/**
 * JSON array containing a list of the OAuth 2.0 response_mode values that this OP supports.
 * @member {Array.<String>} response_modes_supported
 */
WellKnown.prototype['response_modes_supported'] = undefined;
 ...
 */
WellKnown.prototype['scopes_supported'] = undefined;

/**
 * JSON array containing a list of the Subject Identifier types that this OP supports. Valid types include pairwise and public.
 * @member {Array.<String>} subject_types_supported
 */
WellKnown.prototype['subject_types_supported'] = undefined;

/**
 * URL of the OP's OAuth 2.0 Token Endpoint
 * @member {String} token_endpoint
 */
WellKnown.prototype['token_endpoint'] = undefined;
 ...
 */
WellKnown.prototype['token_endpoint_auth_methods_supported'] = undefined;

/**
 * URL of the OP's UserInfo Endpoint.
 * @member {String} userinfo_endpoint
 */
WellKnown.prototype['userinfo_endpoint'] = undefined;

/**
 * JSON array containing a list of the JWS [JWS] signing algorithms (alg values) [JWA] supported by the UserInfo Endpoint to encode the Claims in a JWT [JWT].
 * @member {Array.<String>} userinfo_signing_alg_values_supported
 */
WellKnown.prototype['userinfo_signing_alg_values_supported'] = undefined;
