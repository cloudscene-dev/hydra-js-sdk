...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydra.SwaggerOAuthTokenResponse();
  });
  ...
  describe('SwaggerOAuthTokenResponse', function() {
    it('should create an instance of SwaggerOAuthTokenResponse', function() {
      ...
      //var instane = new OryHydra.SwaggerOAuthTokenResponse();
      //expect(instance).to.be.a(OryHydra.SwaggerOAuthTokenResponse);
    });
