...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydra.OAuth2TokenIntrospection();
  });
  ...
  describe('OAuth2TokenIntrospection', function() {
    it('should create an instance of OAuth2TokenIntrospection', function() {
      ...
      //var instane = new OryHydra.OAuth2TokenIntrospection();
      //expect(instance).to.be.a(OryHydra.OAuth2TokenIntrospection);
    });
